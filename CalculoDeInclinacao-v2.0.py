...
def calcular():
    try:
        comprimento = float(input_comprimento.get()) if input_comprimento.get() else None
        inclinacao = float(input_inclinacao.get()) if input_inclinacao.get() else None
        altura = float(input_altura.get()) if input_altura.get() else None
